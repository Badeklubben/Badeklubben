  ...
  return (
      ...
      <Link href={'member/' + member.id}>
        <div className="member-card-landscape">
            {member.icon ? <Image alt='icon' className="member-card-icon" src={`data:image/svg+xml,${encodeURIComponent(member.icon)}`}></Image> : <RiLockPasswordFill className="member-card-icon"/>}
        </div>
