...
var _ = 255,
	...
	W = (e) => {
		var { r: a, g: r, b: o, a: n } = e,
			t = Math.max(a, r, o),
			h = t - Math.min(a, r, o),
			d = h ? (t === a ? (r - o) / h : t === r ? 2 + (o - a) / h : 4 + (a - r) / h) : 0;
		return {
			h: 60 * (d < 0 ? d + 6 : d),
			s: t ? (h / t) * D : 0,
			v: (t / _) * D,
	...
	ae = (e) => {
		...
		/^#?/.test(e) &&
			a.length === 3 &&
			(e = '#' + a.charAt(0) + a.charAt(0) + a.charAt(1) + a.charAt(1) + a.charAt(2) + a.charAt(2));
	...
	X = (e) => {
		...
		return (
			(s.r = Math.round(s.r)), (s.g = Math.round(s.g)), (s.b = Math.round(s.b)), l({}, s, { a: n })
		);
	},
	Or = (e) => {
		var { r: a, g: r, b: o } = X(e);
	...
	A = (e) => {
		var a, r, o, n, t, h, d, m;
		return (
			typeof e == 'string' && N(e) ? ((h = S(e)), (d = e)) : typeof e != 'string' && (h = e),
			h && ((o = Pe(h)), (t = G(h)), (n = X(h)), (m = ge(n)), (d = L(h)), (r = De(t)), (a = Se(n))),
...
var Y = (e) => 'touches' in e,
	...
	ie = function (a, r, o) {
		return r === void 0 && (r = 0), o === void 0 && (o = 1), a > o ? o : a < r ? r : a;
	},
	de = (e, a) => {
	...
	K = B.forwardRef((e, a) => {
		var { prefixCls: r = 'w-color-interactive', className: o, onMove: n, onDown: t } = e,
			h = E(e, Le),
			d = C.useRef(null),
			m = C.useRef(!1),
			[c, x] = C.useState(!1),
			...
			y = C.useCallback((u) => {
				...
				R(m.current ? 'touchmove' : 'mousemove', f), R(m.current ? 'touchend' : 'mouseup', g);
			}, []);
		C.useEffect(
			() => (
				y(c),
		...
		var p = C.useCallback(
			(u) => {
				ne(u.nativeEvent),
					s(u.nativeEvent) && (b && b(de(d.current, u.nativeEvent), u.nativeEvent), x(!0));
			},
			[b]
		);
		return i.jsx(
...
var He = ['className', 'prefixCls', 'left', 'top', 'style', 'fillProps'],
	Me = (e) => {
		var { className: a, prefixCls: r, left: o, top: n, style: t, fillProps: h } = e,
			d = E(e, He),
...
var We = [
	...
	q = B.forwardRef((e, a) => {
		...
		return i.jsxs(
			...
			l({ ref: a }, b, {
				className: [r, o || ''].filter(Boolean).join(' '),
				style: l({ display: 'flex', flexWrap: 'wrap', position: 'relative' }, h),
				children: [
					...
					t &&
						...
						t.map((g, y) => {
							...
							typeof g == 'string' && ((p = g), (u = g)),
								typeof g == 'object' && g.color && ((p = g.title || g.color), (u = g.color));
...
function Ye(e) {
	var { style: a, title: r, checked: o, color: n, onClick: t, rectProps: h } = e,
		d = C.useRef(null),
		m = C.useCallback(() => {
...
var Ge = [
	...
	be = B.forwardRef((e, a) => {
		...
		/^T/.test(o) &&
			...
			(p.borderColor = 'transparent transparent var(--github-arrow-border-color)'),
			(u.borderWidth = '0 7px 7px'),
			(u.borderColor = 'transparent transparent var(--github-background-color)')),
			o === j.TopRight && ((p.top = -8), (u.top = -7)),
			o === j.Top && ((p.top = -8), (u.top = -7)),
			o === j.TopLeft && ((p.top = -8), (u.top = -7)),
			/^B/.test(o) &&
				((p.borderWidth = '8px 8px 0'),
				(p.borderColor = 'var(--github-arrow-border-color) transparent transparent'),
				(u.borderWidth = '7px 7px 0'),
				(u.borderColor = 'var(--github-background-color) transparent transparent'),
				o === j.BottomRight && ((p.top = '100%'), (u.top = '100%')),
				o === j.Bottom && ((p.top = '100%'), (u.top = '100%')),
				o === j.BottomLeft && ((p.top = '100%'), (u.top = '100%'))),
			/^(B|T)/.test(o) &&
				((o === j.Top || o === j.Bottom) &&
					((p.left = '50%'), (p.marginLeft = -8), (u.left = '50%'), (u.marginLeft = -7)),
				(o === j.TopRight || o === j.BottomRight) && ((p.right = 10), (u.right = 11)),
				(o === j.TopLeft || o === j.BottomLeft) && ((p.left = 7), (u.left = 8))),
			/^L/.test(o) &&
				((p.borderWidth = '8px 8px 8px 0'),
				(p.borderColor = 'transparent var(--github-arrow-border-color) transparent transparent'),
				(u.borderWidth = '7px 7px 7px 0'),
				(u.borderColor = 'transparent var(--github-background-color) transparent transparent'),
				(p.left = -8),
				(u.left = -7)),
			/^R/.test(o) &&
				((p.borderWidth = '8px 0 8px 8px'),
				(p.borderColor = 'transparent transparent transparent var(--github-arrow-border-color)'),
				(u.borderWidth = '7px 0 7px 7px'),
				(u.borderColor = 'transparent transparent transparent var(--github-background-color)'),
				(p.right = -8),
				(u.right = -7)),
			/^(L|R)/.test(o) &&
				((o === j.RightTop || o === j.LeftTop) && ((p.top = 5), (u.top = 6)),
				(o === j.Left || o === j.Right) &&
					((p.top = '50%'), (u.top = '50%'), (p.marginTop = -8), (u.marginTop = -7)),
				(o === j.LeftBottom || o === j.RightBottom) &&
					((p.top = '100%'), (u.top = '100%'), (p.marginTop = -21), (u.marginTop = -20)));
		var R = (F) => {
			var k = l({}, (fe(F), F)),
				w = x && x(l({}, k));
...
var Ke = (e) => {
	...
	Qe = ['prefixCls', 'radius', 'pointer', 'className', 'hue', 'style', 'hsva', 'onChange'],
	Q = B.forwardRef((e, a) => {
		var r,
			{
...
var Je = [
	...
	O = B.forwardRef((e, a) => {
		...
		function f(y) {
			...
			p && p > 255 && (y.target.value = '255'), p && p < 0 && (y.target.value = '0');
		}
		var g = (y, p, u) => {
			typeof y == 'number' &&
				(p === 'a' &&
					(y < 0 && (y = 0), y > 100 && (y = 100), v && v(A(W(l({}, s, { a: y / 100 }))))),
...
var er = ['prefixCls', 'hsva', 'hProps', 'sProps', 'lProps', 'aProps', 'className', 'onChange'],
	xe = B.forwardRef((e, a) => {
		var {
			...
			b = (s, f, g) => {
				typeof s == 'number' &&
					(f === 'h' && (s < 0 && (s = 0), s > 360 && (s = 360), c && c(A(U(l({}, v, { h: s }))))),
					f === 's' && (s < 0 && (s = 0), s > 100 && (s = 100), c && c(A(U(l({}, v, { s }))))),
					f === 'l' && (s < 0 && (s = 0), s > 100 && (s = 100), c && c(A(U(l({}, v, { l: s }))))),
					f === 'a' && (s < 0 && (s = 0), s > 1 && (s = 1), c && c(A(U(l({}, v, { a: s }))))));
			};
		return i.jsx(
			O,
			l(
...
var lr = [
	...
	sr = B.forwardRef((e, a) => {
		var {
			...
			[p, u] = C.useState(v),
			R = () => {
				p === H.RGBA && u(H.HSLA), p === H.HSLA && u(H.HEXA), p === H.HEXA && u(H.RGBA);
			},
			F = { paddingTop: 6 },
											...
											children: [
												...
												p === H.HEXA &&
													i.jsx(M, {
														...
														onChange: (T, z) => {
															typeof z == 'string' && y(S(/^#/.test(z) ? z : '#' + z));
														}
													}),
												p === H.HSLA &&
													i.jsx(xe, {
...
function nr(e) {
	var { style: a, className: r, title: o, checked: n, color: t, onClick: h, rectProps: d } = e,
		m = C.useRef(null),
		c = C.useCallback(() => {
...
var ir = ['prefixCls', 'className', 'color', 'colors', 'rectProps', 'pointProps', 'onChange'],
	dr = B.forwardRef((e, a) => {
		var {
			...
			s = [r + '-point', d == null ? void 0 : d.className].filter(Boolean).join(' ');
		return i.jsx(
			q,
...
var fr = B.forwardRef((e, a) => {
	...
	return i.jsxs(
		'div',
		l({ ref: a, style: y, className: [r, o || ''].filter(Boolean).join(' ') }, x, {
			children: [
				i.jsx(q, {
					colors: d,
					color: h ? L(v) : void 0,
...
var br = ['prefixCls', 'className', 'style', 'color', 'onChange'],
	...
	xr = B.forwardRef((e, a) => {
		var { prefixCls: r = 'w-color-material', className: o, style: n, color: t, onChange: h } = e,
			d = E(e, br),
			...
			v = (s, f) => {
				typeof s == 'string' && N(s) && /(3|6)/.test(String(s.length)) && h && h(A(S(s)));
			},
			b = l(
				{
		...
		return i.jsxs(
			'div',
			l({ ref: a, className: [r, o || ''].filter(Boolean).join(' '), style: b }, d, {
				children: [
					i.jsx(M, {
						label: 'Hex',
						...
						inputStyle: {
							...
							borderBottomColor: c ? '#' + c : 'var(--material-border-bottom-color)',
							borderBottomStyle: 'solid',
							background: 'transparent'
						},
						style: {
...
var kr = [
	...
	Ar = B.forwardRef((e, a) => {
		...
		var f = (w) => {
			...
			g = (w, P) => {
				typeof w == 'string' && N(w) && /(3|6)/.test(String(w.length)) && f(S(w));
			},
			y = (w) => f(l({}, b, { a: w.a })),
			p = (w) => f(l({}, b, w, { a: b.a })),
			u = l(
		...
		var {
			...
			F = {
				...
				transform:
					...
					p.y +
					'px) ' +
					(c === 'x' || c === 'X' ? 'scaleY(2)' : c === 'y' || c === 'Y' ? 'scaleX(2)' : '')
			},
			k =
				n && typeof n == 'function'
				...
				style: l(
					{
						...
						width: d,
						transform:
							c === 'x' || c === 'X' ? 'scaleY(0.5)' : c === 'y' || c === 'Y' ? 'scaleX(0.5)' : '',
						height: m
					},
					h
				),
