...
function Y(y) {
  ...
  let c;
  t[0] !== e
    ? ((c = e == null ? void 0 : e.filter(Z)), (t[0] = e), (t[1] = c))
    : (c = t[1]);
  const n = R(c);
  let s;
  t[2] !== e
    ? ((s = (a) => {
        var j;
        return (
          ((j = e == null ? void 0 : e.find((B, g) => g === a)) == null
            ? void 0
            : j.type) === "divider"
        );
      }),
  ...
  t[6] !== o || t[7] !== n || t[8] !== d || t[9] !== u || t[10] !== I
    ? ((p = (a, j) => {
        ...
        if (a.type === "divider")
          return x.jsx(
            K,
            { marginBottom: 1, children: x.jsx(V, {}) },
            `divider-${B}`,
          );
        const g = !d && o === a.id,
          w = d && o === a.id,
  ...
  return (
    t[17] !== f || t[18] !== h
      ? ((P = x.jsx(q, { overflow: f, children: h })),
        (t[17] = f),
        (t[18] = h),
        (t[19] = P))
      : (P = t[19]),
...
const z = (y) => {
  ...
  let n;
  t[0] !== d || t[1] !== e
    ? ((n = x.jsx(U, { menuItems: e, menuItemGroups: d })),
      (t[0] = d),
      (t[1] = e),
      (t[2] = n))
    : (n = t[2]);
